...
// Điểm sai ở đây là dùng class component thôi
class ProductsPane extends React.Component {
    ...
    removeProduct  = (productId) =>  {
        console.log("Call action remove")
        var action = {
            type: 'REMOVE_PRODUCT',
            productId: productId
        };
...
const appReducer = (state = {productList: []}, action) => {
    console.log("Reducer is handling");
...
// Tương tác với devtool
if (window.devToolsExtension) {
    window.devToolsExtension.open();
}

console.log("CHECK")
console.log(window.devToolsExtension); // đã deprecated và thay bằng window.__REDUX_DEVTOOLS_EXTENSION__
