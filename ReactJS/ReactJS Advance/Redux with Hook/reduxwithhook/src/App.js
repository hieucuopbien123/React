...
function App() {
  ...
  //useDispatch là tham chiếu đến hàm dispatch của redux, useSelector là dùng biến state nào
  ...
  const { count, count1 } = useSelector(state => ({//chú ý kiểu gán lấy {} là lấy 1 phần của object phải đúng
    count: state.count,
    count1: state.count
  }), shallowEqual)
...
//performance cũng chỉ như redux bth k hơn