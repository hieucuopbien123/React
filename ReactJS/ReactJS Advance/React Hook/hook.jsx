...
function Example(props) {//vẫn truyền props vào bth
    ...
    React.useEffect(() => {
        ...
        fetch("https://jsonplaceholder.typicode.com/posts", {
            method: "GET"
        }).then((res) => { setLoading(false); console.log(res.json());})//kiểu promise k xử lý đc
...
//đổi props ở TH này cx làm nó render lại
...
//đc gọi, nó sẽ clean cái useEffect trc nó r mơi thực hiện; 1 quy tác nx là khi component unmount, sẽ tự thực hiện clean
//up tức nếu component unmount sẽ gọi vào return.
...
//     return <div name={console.log("Con")}>Hello</div>
// })
//Dùng React.useMemo (còn useContext thế hoàn toàn kiểu truyền prosp cũ)
const Con = props => {
