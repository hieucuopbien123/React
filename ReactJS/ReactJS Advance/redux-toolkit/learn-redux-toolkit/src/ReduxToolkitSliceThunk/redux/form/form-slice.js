...
const otherAction = createAction("testOtherAction");
...
//nếu dùng createReducer thì phải return 1 object chứa state cũ
//nếu dùng reducer kiểu này thì có thể làm dưới dạng function để ta xử lý, gán trực tiếp. Chỉ cần sửa gán những cái
//nào đổi
