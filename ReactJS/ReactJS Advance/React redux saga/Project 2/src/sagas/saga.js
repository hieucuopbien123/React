...
//hàm này như bên trên. Latest tức là nếu nhiều action được gởi tới đồng thời, thì nó chỉ nhận 1 action cuối cùng và
//gởi action này cho worker xử lý, hủy tất cả các nhiệm vụ đã giao trước đó
//=>Cơ chế: check gửi action tới khớp k với take->khớp thì check xem nv trc hoàn thành chưa, nếu chưa thì gọi 
//cancel('<task>')sau đó gọi fork. Vai trò fork là tạo task nền xử lý và lưu lại kết quả cho hành động tiếp theo lại từ
//đầu(vòng lặp) takeLeading: xử lý action gửi tới đầu tiên->các action gửi tới sau sẽ k nhận nếu chưa hoàn thành cái trc
