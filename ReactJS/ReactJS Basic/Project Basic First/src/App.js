...
function CheckboxExample() {
  ...
  return (
    ...
    //Nếu 1 thẻ mà chỉ có icon thì nên dùng. Với các thẻ đã specific mọi thứ text thì trình đọc sẽ đọc nó rõ ràng
    //mà k càn dùng thuộc tính này. phần text của nó là phần mà trình đọc sẽ đọc
  )
}

const theme = createTheme({//để custom các thẻ áp dụng với toàn bộ class có sẵn của MUI
  //createTheme sẽ tạo theme cung cho ThemeProvider
