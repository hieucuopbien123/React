...
class Button extends React.Component {
    ...
    render() {
        ...
        );//có thể tùy ý truy cập vào thuộc tinh và hàm của class thông qua {this.<>}-> kết hợp của xml và JS
    ...
    //thật ra onClick={<function bth>} thì cái function đó ta phải viết như bth trừ khi nó dùng arrow function gán
