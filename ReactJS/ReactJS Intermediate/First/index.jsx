...
function Child({ match }) {//match chỉ có khi dùng component={}
...
//match là 1 object props đặc biệt cho phép truy cập vào các thông tin mà router cung cấp.
//params của match là các đối số của sau đg path
