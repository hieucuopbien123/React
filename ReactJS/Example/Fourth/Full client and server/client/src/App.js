...
class App extends Component{
  constructor(props){
    ...
    this.state = {
      ...
      nameModal: "",
      indexModal: 0
    }//đáng lẽ data ở đây sẽ được lưu vào store của redux
  ...
  render(){
    return (
      <div>
        ...
        {/* con mẹ nó button chỉ có onClick, onSubmit là của form r */}
        <br/><br/>
        <table style={{border: "1px solid", borderStyle: "groove"}}>
          <thead>
            {/* thẻ tr kbh chỉnh đc padding và margin nhé, phải chỉnh ở th, td */}
            <tr>
              <th>Name</th>
              <th>Age</th>
            </tr>
