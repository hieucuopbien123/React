    ...
    app.get("/api/first", (req,res) => {
        requestSQL.query("SELECT * FROM Table1", (err, recordset)=>{
            if(err)
                ...
                //chú ý nếu ta send đi kiểu {data: recordset.recordset} thì nó nhận kp là 1 mảng mà là 1 object chứa
                //mảng-> tức là bên client phải get là res.data.data mới ra mảng-> thôi thì ta gửi bth k chuyển sang
                //object nx
            }
        })
    })
