...
//Thêm kiến thức mới là useContext k có setNickname nhưng vẫn lấy được ở Header=> khởi tạo context chỉ là để rõ ràng
//và có giá trị ban đầu thôi chứ truyền vào value k có vẫn đc
...
//Ta có thể chia ra làm nhiều context khác nhau sẽ fix được điều này
const Context1 = React.createContext({
    nickname: ""
})
...
//kinh nghiệm: nếu có biến ở trong function-> hãy dùng useMemo cho nó
//nếu có hàm trong function-> dùng useCallback cho nó
//Nếu các components con bên trong bị render lại-> memo or useMemo cho nó => components này thg là 1 component lớn