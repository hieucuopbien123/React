function useTest(count){
    React.useEffect(() => {
        if(count%2 == 0)
            ...
            console.log("hallo")
            //chú ý custom hook như này thực hiện 2 lần
    })
}
function FirstBasic(){
...
//2 cái éo khác gì nhau nhưng các hook chỉ được dùng trong 1 component nào đó(1 hàm số or 1 class) chứ nếu gọi riêng
//thì lỗi ngay nên useMemo lại phải nhét vào 1 function arrow như trên dài dòng hơn. 2 cách thật ra tương tự nhau. Dùng
//useMemo thì nó gán Con2 cho 1 component và component đó return luôn 1 component khác thì cx như gán trực tiếp thôi